...
struct Typography
{
    ...
    static const touchgfx::FontId VALUE = 3;
    static const touchgfx::FontId TITLE = 4;
    static const touchgfx::FontId ANNOTATIONS = 5;
    static const touchgfx::FontId FLOAT = 6;
};
...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId VALUE = 3;       // consola_28_8bpp
    static const touchgfx::FontId TITLE = 4;       // consolab_24_4bpp
